...
func init() {
	flag.StringVar(&brokers, "brokers", "localhost:9093", "Kafka bootstrap brokers to connect to, as a comma separated list")
	flag.StringVar(&group, "group", "sarama", "Kafka consumer group definition")
	flag.StringVar(&version, "version", "3.4.0", "Kafka cluster version")
	flag.StringVar(&topics, "topics", "polygon2", "Kafka topics to be consumed, as a comma separated list")
...
func main() {
	...
	log.Println("Consumption cancelling...")
